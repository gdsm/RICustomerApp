...
{
    NSCharacterSet* characterSet = [NSCharacterSet phoneNumberCharacterSet];
    NSString * retVal = [[phoneNumber componentsSeparatedByCharactersInSet:characterSet] componentsJoinedByString:@""];
    return retVal;
}
